...
// playgroundMFC.cpp: определяет поведение классов для приложения.
//
...
// Создание CplaygroundMFCApp

CplaygroundMFCApp::CplaygroundMFCApp()
{
...
// Единственный объект CplaygroundMFCApp

CplaygroundMFCApp theApp;


// Инициализация CplaygroundMFCApp
